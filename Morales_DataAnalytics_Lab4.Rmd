...
bronx1<- read.csv("C:/Users/morale3/Desktop/Data_Analytics/Lab4/rollingsales_bronx.csv")
#bronx1<-read.csv(file.choose(),pattern="BOROUGH",stringsAsFactors=FALSE,sheet=1,perl="<SOMEWHERE>/perl/bin/perl.exe") 
...
if (!require("class")) {
   ...
   library(class)}
nyt1<-read.csv("C:/Users/morale3/Desktop/Data_Analytics/Lab4/nyt1.csv")
